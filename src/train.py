...
os.makedirs(os.path.dirname("output/train/"), exist_ok=True)
with open("output/train/train_accuracy.csv", "w") as f:
    f.write(history_to_csv(history, 'accuracy'))
with open("output/train/train_loss.csv", "w") as f:
    f.write(history_to_csv(history, 'loss'))
